 ...
 * @version 1.0
 */
public class View_TTI_Horizontal extends LinearLayout {

    private TextView left_textView;
    private TextView centreTextView;
    private ImageView rightImageView;

    public View_TTI_Horizontal(Context context) {
        super(context);
        init(context);
    }

    public View_TTI_Horizontal(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context){
        LayoutInflater.from(context).inflate(R.layout.view_tti_horizontal,this,true);
    ...
    public View_TTI_Horizontal setLeft_textView(TextView left_textView) {
    ...
    public View_TTI_Horizontal setCentreTextView(TextView centreTextView) {
    ...
    public View_TTI_Horizontal setRightImageView(ImageView rightImageView) {
