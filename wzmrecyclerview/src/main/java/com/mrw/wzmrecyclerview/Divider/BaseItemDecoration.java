...
public class BaseItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public BaseItemDecoration(Context mContext, int res) {
        ...
        this.mHeight = mDivider.getIntrinsicHeight() <= 0 ? height : mDivider.getIntrinsicHeight();
        this.mWidth = mDivider.getIntrinsicWidth() <= 0 ? height : mDivider.getIntrinsicWidth();
    }
